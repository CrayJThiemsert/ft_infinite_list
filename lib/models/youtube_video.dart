...
//  List<Items> items;
//
//  YoutubeVideo({this.kind, this.etag, this.nextPageToken, this.regionCode, this.pageInfo, this.items});
//
...
//  Default high;
//
////  Thumbnails({this.default, this.medium, this.high});
//  Thumbnails({this.medium, this.high});
//
//  Thumbnails.fromJson(Map<String, dynamic> json) {
////    default = json['default'] != null ? new Default.fromJson(json['default']) : null;
